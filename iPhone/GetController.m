...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
	NSDictionary *contact = [[Contacts sharedContacts]._contacts objectAtIndex:[indexPath row]]; // TODO crashing here - unrecognized selector
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	ContactController *detailViewController = [[ContactController alloc] initWithNibName:@"ContactView" bundle:nil];
	// ...
...
- (void)restConnection:(NSURLConnection *)connection didReturnResource:(id)resource object:(id)object {
	...
	[self.tableView reloadData]; // TODO not refreshing
}
